...
def main():
    # 2)
    counts_not_signs = count_samples_dir('./prep/nosign')
    counts_signs = count_samples_dir('./prep/sign')

    print(counts_not_signs)  # {'vodit_udostav': 348, 'photo': 598, 'passport_and_vod': 255, 'unknown': 531, 'passport': 4357, 'pts': 1190}
    print(counts_signs)  # 363
    # # 1)
    try:
        ...
        pass
    # # test
    prep_to_fineprep({'sign': counts_signs, 'nosign': counts_not_signs}, directory_path='./prep/', medium_quantity=4000,
                     size_x=round(siz // 2 // 2), size_y=siz // 2 // 2)
    ...
    try:
        ...
        pass
    split('./fineprep/', 0.2)  # from ./fineprep/ to ./train and ./test
    # 6)
