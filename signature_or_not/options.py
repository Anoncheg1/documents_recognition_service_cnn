...
def options_set():
    ...
    parser.add_argument("--batchSize", type=int, default=5, help="")
    parser.add_argument("--epochs", type=int, default=12, help="")
    parser.add_argument("--lr", type=float, default=9e-3, help="")
    parser.add_argument("--decay", type=float, default=0.9, help="")  #20 - 0.05464744489458512, 50 - 0.4738555173642436
    ...
    parser.add_argument("--size_x", type=int, default=siz // 2 // 2, help="")
    parser.add_argument("--size_y", type=int, default=siz // 2 // 2, help="")
    opt = parser.parse_args()
    opt.channels = 3
    # opt.model = "passport_page"
    # opt.model = "all_classes"
    opt.model = "binary"
    # opt.net = 'mobilenet'
    # opt.net = 'highway'
    opt.net = 'keras'
